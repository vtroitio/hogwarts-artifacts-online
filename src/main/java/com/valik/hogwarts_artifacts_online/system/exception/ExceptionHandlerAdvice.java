...
public class ExceptionHandlerAdvice {
    ...
    Result handleInvalidBearerTokenException(InvalidBearerTokenException ex) {
        return new Result(false, StatusCode.UNAUTHORIZED, "The access token provided is expired, revorked, malformed, or invalid for other reasons." , ex.getMessage());
    }
    ...
    Result handleOtherException(Exception ex) {
        return new Result(false, StatusCode.INTERNAL_SERVER_ERROR, "A server internal error ocurrs." , ex.getMessage());
    }
