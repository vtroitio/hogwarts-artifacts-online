...
class UserControllerTest {
    ...
    void testFindUserByIdNotFound() throws Exception {
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        given(this.userService.findById(5)).willThrow(new ResourceNotFoundException("user", 5));
    ...
    void testUpdateUserErrorWithNonExistentId() throws Exception {
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        given(this.userService.update(eq(5), Mockito.any(HogwartsUser.class))).willThrow(new ResourceNotFoundException("user", 5));
    ...
    void testDeleteUserErrorWithNonExistentId() throws Exception {
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        doThrow(new ResourceNotFoundException("user", 5)).when(this.userService).delete(5);
